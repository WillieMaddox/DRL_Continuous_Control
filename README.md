...
2. Clone the repository (if you haven't already!), and install several dependencies.
    ```bash
    git clone https://github.com/WillieMaddox/DRL_Continuous_Control.git
...
3. Download the environment from one of the links below.  You need only select the environment that matches your operating system:
    ...
    Note: all the code in the `communicator_objects` and `unityagents` folders contains the necessary files needed to communicate with the Reacher simulator.  I simply copied the required files from the [ml-agents](https://github.com/Unity-Technologies/ml-agents) repo for convenience.
